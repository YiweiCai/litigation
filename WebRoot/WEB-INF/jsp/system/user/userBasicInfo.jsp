	...
	<script type="text/javascript">
		...
		$(function(){
			...
			$("#submitBtn").submitForm({ 
				formId:"userForm",
				onComplete:function(){
				    window.location.href="${ctx4ej}/system/user_toUserBasicInfo.do";
				}
			});
		...
		function deleteUploadFile(id){
		      if(confirm("您确定要删除吗")){
		          window.location.href="${ctx4ej}/system/user_deleteUserPicture.do?uploadFileId="+id;
	          }
	     }
	     $(function() {
...
<div class="phead">
	...
	<div class="clear"></div>
	    ...
	    <div id="result" align="center" style="color: red"></div>
		  <form id="userForm" action="${ctx4ej}/system/user_updateUserBasicInfo.do" method="post" enctype="multipart/form-data">
