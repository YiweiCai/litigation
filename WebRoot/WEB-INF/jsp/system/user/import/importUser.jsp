...
<div class="bodybox">
<div class="phead">
    <div class="pheadposition"><my:i18n zhText="当前位置" enText="Current Position"/>：<my:i18n zhText="导入用户" enText="Import Users From A Excel"/></div>
	<div class="clear"></div>
</div>
<div id="result" align="center" style="color: red;"></div>
    <form method="post" action="${ctx4ej }/system/userreport_importExcel.do" id="form" enctype="multipart/form-data">
     <table width="100%" class="ftable">
	  ...
	  <tr>
		  <th>用户模板：</th>
		  <td><a href="${ctx4ej }/system/userreport_download.do">点击下载</a></td>
	  </tr>
	  <tr>
