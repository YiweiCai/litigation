	...
	<tbody class="ltablebody">
		...
		<c:forEach items="${logFileMap}" var="entry" varStatus="status">
		  <tr>
				...
				<td>${entry.value}</td>
				<td align="center">
				   <a href="${ctx}/system/accesslog_detail.do?logPath=${entry.value}" target="_blank">查看</a> | 
				   <a href="${ctx}/system/accesslog_downLoad.do?logPath=${entry.value}">下载</a>
				</td>
			</tr>
		</c:forEach>
	</tbody>
</table>
 <div class="ltablebottom" style="display: none">
