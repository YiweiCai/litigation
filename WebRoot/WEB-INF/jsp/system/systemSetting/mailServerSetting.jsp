...
<div class="bodybox">
 ...
 <div>
			...
			<td>
				<div align="center" id="uldiv">
					  <ul>
					    ...
					    <li id="current"><a href="${ctx4ej}/system/systemSetting_addMailServerSetting.do"><span><my:i18n zhText="邮箱服务器设置" enText="Mail Server Setting"/></span></a></li>
					  </ul>
				</div>
			 </td>
			</tr>
  ...
  <div id="result" align="center" style="color: red"></div>
		  <form id="mailServerSetting" action="${ctx4ej}/system/systemSetting_saveMailServerSetting.do" method="post">
