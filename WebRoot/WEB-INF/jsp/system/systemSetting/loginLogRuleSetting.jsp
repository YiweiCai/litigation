 ...
 <div>
   ...
   <div class="phead">
	<div class="pheadposition">
		...
		<my:i18n zhText="登录日志设置" enText="Login Log Setting"/>
	</div>
  </div>
  ...
  <div id="result" align="center" style="color: red"></div>
		  ...
		  <table width="100%" class="ftable">
           <tr>
            <th align="right" width="20%">用户登录系统，是否记录登录日志：</th>
            <td id="desks">
          ...
          <tr>
            ...
            <td>
                1、  如果选择了“是”，在用户正常退出系统时，将记录他的登录日志到数据库中；<br/>
                2、 记录日志信息见：日志管理 > 用户登录日志；<br/>
                3、非正常退出，将无法记录到登录日志。
            </td>
          </tr>
          <tr>
