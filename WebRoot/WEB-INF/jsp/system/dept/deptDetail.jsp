	...
	<script type="text/javascript">
	    $(function() {
			$("#submitBtn").submitForm({ 
				...
				resetForm:false,
				onComplete:function(){
					parent.refreshTree('${id }',$("#${locale.language}DeptName").val());
				}
			});
		});
	</script>
		...
		<tr>
			<td>
				<div align="center" id="uldiv">
					  <ul>
						<li id="current"><a href="${ctx4ej }/system/dept_update.do?id=${id }"><span><my:i18n zhText="本部门信息" enText="Dept Info"/></span></a></li>
		  ...
		  <form id="deptForm" action="${ctx4ej}/system/dept_save.do" method="post">
         ...
         <tr>
          ...
          <tr>
            ...
            <td><input type="text" name="webSite" value="${webSite }"></td>
              ...
              <tr>
                  <th ><my:i18n zhText="所属机构" enText="organization"/>：</th>
