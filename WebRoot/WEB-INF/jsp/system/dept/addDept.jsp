        ...
        $(function() {
			$("#submitBtn").submitForm({ 
				...
				onComplete:function(id){
					parent.addNode('contentIframe',$("#parentDeptId").val(),id,$("#${locale.language}DeptName").val(),"${ctx4ej}/system/dept_update.do?id="+id);
				}
			});
		});
	</script>
		...
		<tr>
			<td>
				<div align="center" id="uldiv">
					<ul>
						<li><a href="${ctx4ej }/system/dept_update.do?id=${id }"><span><my:i18n zhText="本部门信息" enText="Dept Info"/></span></a></li>
						<li><a href="${ctx4ej }/system/dept_list.do?id=${id }"><span><my:i18n zhText="下级部门列表" enText="Sub Dept List"/></span></a></li>
						<li id="current"><a href="${ctx4ej }/system/dept_add.do?id=${id }"><span><my:i18n zhText="新增下级部门" enText="Add A New Dept"/></span></a></li>
					  </ul>
				</div>
			 </td>
			</tr>
          ...
          <tr>
              <th width="18%"><font color="red">*</font><my:i18n zhText="所属机构" enText="Organization Name"/>：</th>
              <td><input type="text" name="organization" value="${sysDept.organization }" rules="[{notNull:true, message:'<my:i18n zhText="请输入所属机构名称" enText="Please Enter Organization Name"/>'}]"></td>
          </tr>
          <tr>
