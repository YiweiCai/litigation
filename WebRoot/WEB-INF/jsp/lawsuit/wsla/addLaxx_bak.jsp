...
<div class="errortips" style="display:none">
    <div class="errorleft">请正确填写信息！</div>
     <div class="errorright">身份证位数不正确！</div></div>
			<label>出生日期</label><input name="temp.csrq"  type="text" class="inputsubmit" > 
			<label>性别</label>
	...
	<div id="bg_zrr" class="comeare" style="display: none;">
				...
				<h2><span><img src="${ctx}/js_css_image/images/editicon.jpg" /><img src="${ctx}/js_css_image/images/deleteicon.png" onclick="deleteDiv(this);" tag="bg"/></span>被告自然人</h2>
			
				    <input name="temp.ssdw" value="1" type="hidden">
					<input name="temp.type" value="0" type="hidden">
			<label>姓名</label><input name="temp.name"  class="inputsubmit" type="text" value="" >
...
<h2><span><img src="${ctx}/js_css_image/images/deleteicon.png" onclick="deleteDiv(this);" tag="bg"/></span>被告法人</h2>			
					...
					<br/><label>邮政编码</label><input type="text" name="temp.zybm"  class="inputsubmit">
					<label>手机号码</label><input type="text" name="temp.sjhm" value=""  onblur="checkMobile(this);"  class="inputsubmit">
					<br/><label>联系电话</label><input type="text" name="temp.lxdh"  class="inputsubmit">
	...
	<form id="dataUpload" name="dataUpload" action="${ctx }/lawsuit/laxx_save.do" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
	...
	<div class="message_add">
		...
		<button point="yg_zrr|yg_formContent|yg_init" id="ygzrr" type="button" class="btn1 small">原告自然人</button>
		<button point="yg_fr|yg_formContent|yg_init" id="ygfr" type="button" class="btn1 small">原告法人</button>
		<button point="yg_ffr|yg_formContent|yg_init" id="ygffr" type="button" class="btn1 small">原告非法人其他组织</button>
	</div>
				<div id="yg_formContent" style="margin-left:4px;">
				<div id="yg_init" style="height: 20px; text-align: center; line-height: 25px; color: red; margin-bottom: 10px;">
			请添加原告当事人！</div>
			</div>
  ...
  <img src="${ctx}/js_css_image/images/ssqqtitle.jpg" /> <br /><br />
			<br>
			案件类型
							<select name="lsLaxx.ajlx" class="selectsubmit" >
	...
	<br>诉的种类
							<select name="lsLaxx.sdzl" onchange="change(this);" class="selectsubmit">
								<option value="">请选择诉的种类</option>
								<option value="0">变更之诉</option>
								<option value="1">确认之诉</option>
								<option value="2">给付之诉</option>
							</select>
					...
					<br/>
						<span style="vertical-align:top; margin-top:6px; display:inline-block">填写诉讼请求：</span>
							...
							<textarea name="ssqq" class="texteare"></textarea>

			<br>
			<div class="message_add"> <img src="${ctx}/js_css_image/images/sccltitle.jpg" /> <button type="button" onclick="addUpload();" class="btn1 small">材料上传</button></div>
			
			<br/>
			<div id="formContent3" class="materselect">
			...
			<div class="lead_btn" style="margin-top: 20px; margin-left:200px;">
					<a class="btn1 btn_reset" href="javascript:history.go(-1)">上一步</a>&nbsp;&nbsp;&nbsp;&nbsp;
					<input id="submitBtn" class="btn1 btn_yellow" type="button" value=" 提 交 ">
				</div>
				</form>
		</div>
	</div>
	...
	$(document).ready(function(){
		...
		$("button[point]").click(function(){
		    ...
		    $(".comeare:not(:hidden)").each(function(){
		    	$(this).find(":input[type='text'],:input[type='checkbox']:checked,:input[type='radio']:checked,:input[type='hidden'],select:selected").each(function(){
