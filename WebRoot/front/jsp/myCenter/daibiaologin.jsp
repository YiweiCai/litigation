...
<div class="daibiaologinbg">
  <div class="layout">
    <div class="logineare">
      <div class="loginname">代表委员登录</div>
      <label class="label" for="textfield" style="width:60px;">编&nbsp;&nbsp;&nbsp;号</label>
     <input type="text" class="inputstyle" id="loginName" name="loginName" value="" placeholder="请输入代表委员编号" title="请输入代表委员编号" maxlength="16" />
      ...
      <br />
      <div class="reg">没有账号，<a href="${ctx}/myCenter/daibiaoreg.htm">注册代表委员账号</a></div>
    </div>
  </div>
</div>
