...
<div class="layerloginbg">
  <div class="layout">
    <div class="layerlogineare">
      <div class="loginname">律师登录</div>
      <label class="label" for="textfield" style="width:60px;">律师证号</label>
     <input type="text" class="inputstyle" id="loginName" name="loginName" value="" placeholder="请输入律师证号" title="请输入律师证号" maxlength="16" /><br />
		                    	
      <label for="textfield" class="label" style="width:60px;">密&nbsp;&nbsp;&nbsp;码</label>
      ...
      <br />
      <div class="reg">没有账号，<a href="${ctx}/myCenter/layerreg.htm">注册律师账号</a></div>
    </div>
  </div>
</div>
