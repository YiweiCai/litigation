function hintTip() {
	...
	$("[HintTitle],[HintInfo]").focus(function (event) {
		var hintTitle = $(this).attr("HintTitle");
		if(hintTitle=="" || hintTitle == undefined){
			hintTitle = "提示";
		}
		
		$("*").stop(); //停止所有正在运行的动画
		$("#HintMsg").remove(); //先清除，防止重复出错
		var HintHtml = "<ul id=\"HintMsg\"><li class=\"HintTop\"></li><li class=\"HintInfo\"><b>" + hintTitle + "</b>" + $(this).attr("HintInfo") + "</li><li class=\"HintFooter\"></li></ul>"; //设置显示的内容
