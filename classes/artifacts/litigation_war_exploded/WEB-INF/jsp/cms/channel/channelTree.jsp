 ...
 <script type="text/javascript">
		...
		var setting = {data: {simpleData: {enable: true}}};
			...
			<c:forEach items="${channelList}" var="channel">
			    ...
			    <%--var url = "/cms/channel_update.do?id="+id;--%>
			    var url = "${ctx4ej}/cms/channel_update.do?id="+id;
		...
		$(function(){
				...
				<c:forEach items="${channelList}" var="channel" end="0">
 		           <%--$.loadIframe("contentIframe","/cms/channel_update.do?id=${channel.id}");--%>
 		           $.loadIframe("contentIframe","${ctx4ej}/cms/channel_update.do?id=${channel.id}");
 		        </c:forEach>
			});
	 </script>
</my:head>
