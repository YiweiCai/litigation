...
<body class="easyui-layout">
   <div region="west" split="true" title="菜单导航" border="false" style="width:196px;padding:10px;padding-top:1px;">
		<script type="text/javascript">
		d = new dTree('d');
		<c:forEach items="${menuList}" var="menu">
		    ...
		    var menuPath = "/system/menu_update.do?id=1";
		    <c:if test="${!empty menu.sysMenu}">
		    	parentId = "${menu.sysMenu.id}";
			</c:if>
		    if(parentId!="-1"){
		    	menuPath="/system/menu_update.do?id="+menuId;
			}
