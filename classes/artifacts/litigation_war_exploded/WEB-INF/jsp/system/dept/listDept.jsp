...
<my:head lhgdialog="true">
   ...
   <script type="text/javascript">
		...
		var deleteurl = "${ctx4ej }/system/dept_delete.do";
		$(function() {
			$("#importDept").click(function(){
				<%--var url = '${ctx }/system/dept_toImportDept.do';--%>
				var url = '${ctx4ej }/system/dept_toImportDept.do';
 ...
 <div>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabs1" >
		<tr>
			<td>
				<div align="center" id="uldiv">
					 <ul>
						...
						<li id="current"><a href="${ctx4ej }/system/dept_list.do?id=${id }"><span><my:i18n zhText="下级部门列表" enText="Sub Dept List"/></span></a></li>
						<li><a href="${ctx4ej }/system/dept_add.do?id=${id }"><span><my:i18n zhText="新增下级部门" enText="Add A New Dept"/></span></a></li>
					  </ul>
				</div>
			 </td>
			</tr>
		   ...
		   <form action="${ctx4ej }/system/dept_list.do" method="post" id="deptForm">
			            ...
			            <tbody class="ltablebody">
				           ...
				           <c:forEach items="${page.list}" var="dept" varStatus="status">
				             <tr id="${dept.id }">
									...
									<td>
									   <a href="${ctx4ej }/system/dept_update.do?id=${id}"><my:i18n zhText="${dept.deptName}" enText="${dept.enDeptName}"/></a>
							    	</td>
