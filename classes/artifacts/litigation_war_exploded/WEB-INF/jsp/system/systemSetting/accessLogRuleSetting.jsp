			...
			<td>
				<div align="center" id="uldiv">
					  <ul>
						...
						<li><a href="${ctx4ej}/system/systemSetting_addRuleSetting.do?ruleType=loginLog"><span><my:i18n zhText="登录日志设置" enText="Login Log Setting"/></span></a></li>
						<li id="current"><a href="${ctx4ej}/system/systemSetting_addRuleSetting.do?ruleType=accessLog"><span><my:i18n zhText="系统访问日志设置" enText="System Access Log Setting"/></span></a></li>
		  ...
		  <table width="100%" class="ftable">
           ...
           <tr>
            ...
            <td>
                 ...
                 2、该日志文件将会很庞大，保存到数据库，将会影响数据库的系统，因此保存到日志文件：服务器所在目录/logs/core/AccessLogFile.log中；<br/>
