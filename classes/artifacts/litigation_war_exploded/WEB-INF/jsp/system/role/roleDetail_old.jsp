				...
				<tr>
					<td>
						 <div align="center" id="uldiv">
							<ul>
								<li id="current"><a href="${ctx }/system/role_update.do?id=${id }"><span>角色信息</span></a></li>
								<li><a href="${ctx }/system/role_list.do?id=${id }"><span>下级角色列表</span></a></li>
								<li><a href="${ctx }/system/role_add.do?id=${id }"><span>新增下级角色</span></a></li>
							</ul>
						    </div>
						</td>
					</tr>
          ...
          <tr>
           ...
           <tr>
			<td colspan="4" class="ftablebutton">
				<input type="button" class="button orange"  value="<my:i18n zhText="更新" enText="Update"/>" onclick="submitForm()" class="submitForm"/> &nbsp; <input type="reset" class="button orange"  value="<my:i18n zhText="重置" enText="Reset"/>"/>
			</td>
	      </tr>
        </table>
        </form>
