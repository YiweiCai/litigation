	...
	<script type="text/javascript">
		...
		$(function(){
	        ...
	        $("#exportExcel").click(function(){
				$("#userForm").attr("action","${ctx4ej }/system/userreport_exportExcelDetail.do").submit();
			});
			$("#exportWord").click(function(){
				$("#userForm").attr("action","${ctx4ej }/system/userreport_exportWordDetail.do").submit();
			});
			$("#exportPdf").click(function(){
				$("#userForm").attr("action","${ctx4ej }/system/userreport_exportPdfDetail.do").submit();
			});
		});
		 $(function() {
	...
	<div class="clear"></div>
	    ...
	    <div id="result" align="center" style="color: red"></div>
          ...
          <tr>
            ...
            <td colspan="3">
              <input type="text" name="loginName" value="${loginName}" id="loginName" <c:if test="${!empty loginName }">readonly</c:if> rules="[{notNull:true, message:'<my:i18n zhText="请输入账号" enText="Please Enter Account"/>'}]"></input>
            </td>
           </tr>
          <tr>
           ...
           <tr>
            <th width="12%"><font color="red">*</font><my:i18n zhText="姓名" enText="Chinese Name"/>：</th>
          ...
          <tr>
           ...
           <tr>
            ...
            <th align="right"><font color="red">*</font><my:i18n zhText="角色" enText="Role"/>：</th>
            <td>
