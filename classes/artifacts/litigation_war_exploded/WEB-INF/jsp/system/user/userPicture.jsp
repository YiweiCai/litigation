	...
	<script type="text/javascript">
		...
		$(function(){
		 ...
		 function deleteUploadFile(id){
		      if(confirm("您确定要删除吗")){
		          window.location.href="${ctx4ej}/system/user_deleteUserPicture.do?pictureOnly=yes&uploadFileId="+id;
	          }
	     }
...
<div id="result" align="center" style="color: red;"></div>
    <form method="post" action="${ctx4ej}/system/user_uploadUserPicture.do" id="ufForm" enctype="multipart/form-data">
      <input type="hidden" name="user.id" value="${userSession.id }">
      <table width="100%" class="tabledetail" id="ftable">
      <tr>
		  <th width="15%" >上传照片：</th>
		  <td nowrap="nowrap">
