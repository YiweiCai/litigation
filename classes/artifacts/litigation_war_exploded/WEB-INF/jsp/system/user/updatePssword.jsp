	    ...
	    <div id="result" align="center" style="color: red"></div>
          ...
          <tr>
           ...
           <tr>
            ...
            <td align="left"><input type="password" name="conNewPassword" value="" id="conNewPassword" style="width: 148px;height: 16px" rules="[{notNull:true, message:'确认新<my:i18n zhText="请输入密码" enText="Please Enter Password"/>'},{equalWith:'newPassword',message:'确认密码需等于新密码'}]"></td>
          </tr>
           <tr>
			<td colspan="4" id="ftablebutton">
