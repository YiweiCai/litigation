	...
	<script type="text/javascript">
	 $(function() {
		 $("#submitBtn").submitForm({ 
			 formId:"ddForm",
			 onSubmit:function(){//判断参数值是否存在
			    //$.post("${ctx }/system/datadictionary_judgeDdValue.do?dd.ddValue="+$("#ddValue").val(),
			    //   function(ret){
			    //	   if(ret!=""){
			    //		   alert(ret);
			    // 	   return false;
			 ...
			 onComplete:function(id){
				parent.addNode('contentIframe',$("#parentId").val(),id,$("#${locale.language}DdName").val(),"${ctx4ej}/system/datadictionary_update.do?id="+id);
			 }
	     });
	 });
	</script>
 ...
 <div>
	<table width="100%" border="0" cellpadding="0" cellspacing="0" id="tabs1" >
		<tr>
			<td>
				<div align="center" id="uldiv">
					<ul>
						...
						<li id="current"><a href="${ctx4ej }/system/datadictionary_add.do?id=${id }"><span><my:i18n zhText="新增下级参数" enText="Add A New Param"/></span></a></li>
					</ul>
				</div>
			 </td>
			</tr>
		  ...
		  <input type="hidden" name="parentDD.id" id="parentId" value="${parentDD.id }">
          ...
          <tr>
            ...
            <td><input type="text" name="ddValue" value="${ddValue }" id="ddValue"></td>
          </tr>
          <tr>
