...
<div class="submitconent" id="submitconent">
	<div class="row">
		...
		<div id="bg_zrr" class="comeare" style="display: none;">
			...
			<label>性别</label> <input name="temp.sex" type="checkbox" value="boy">男
			<input type="checkbox" name="temp.sex" value="girl">女 <br>
		...
		<form id="dataUpload" name="dataUpload"
			action="${ctx }/lawsuit/laxx_save.do" method="post"
