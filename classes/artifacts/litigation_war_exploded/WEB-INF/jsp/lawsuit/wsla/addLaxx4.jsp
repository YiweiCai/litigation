...
<h2><span><img src="${ctx}/js_css_image/images/deleteicon.png" onclick="deleteDiv(this);" tag="bg"/></span>被告法人</h2>			
			...
			<div id="zhengju" class="zhengju" style="width:600px; padding:0px 10px 26px 10px;  display: none;">
	...
	<form id="dataUpload" name="dataUpload" action="${ctx4ej }/lawsuit/laxx_save4.do?coid=${coid}" method="post" enctype="multipart/form-data" accept-charset="UTF-8">
			...
			<div class="message_add"> <img src="${ctx}/js_css_image/images/step04.jpg" /> <button type="button" onclick="addUpload();" class="btn1 small">材料上传</button></div>
			...
			<div class="lead_btn" style="margin-top: 20px; margin-left:200px;">
					<a class="btn1 btn_reset" href="${ctx4ej }/lawsuit/laxx_goBack.do?goTo=3&coid=${coid}">上一步</a>&nbsp;&nbsp;&nbsp;&nbsp;
	...
	$(document).ready(function(){
		...
		$('#submitBtn').submitForm({
				formId:"dataUpload",
				onComplete:function(){
				top.location.href = "${ctx4ej}/lawsuit/laxx_myCase.htm?op=caseProceed";  
				}
