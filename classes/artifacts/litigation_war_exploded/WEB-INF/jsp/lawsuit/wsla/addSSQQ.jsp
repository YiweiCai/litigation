	...
	<div class="row">
		...
		<div id="yg_zrr" class="comeare" style="display: none;">
			...
			<input name="temp.ssdw" value="0" type="hidden"> <input
				...
				name="temp.name" type="text" value="" class="inputsubmit">
			<label>身份证</label><input type="text" name="temp.sfz" value=""
			...
			<label>出生日期</label><input name="temp.csrq" type="text"
				class="inputsubmit">? <label>性别</label> <input
				name="temp.sex" type="checkbox" value="boy">男 <input
				name="temp.sex" type="checkbox" value="girl">女 <br /> <label>民族</label><input
				name="temp.mz" type="text" class="inputsubmit"> <label>手机号码</label><input
				...
				name="temp.gj" class="inputsubmit" type="text"><br /> <label>文化程度</label><input
				type="text" name="temp.whcd" class="inputsubmit">? <label>邮政编码</label><input
				type="text" name="temp.yzbm" class="inputsubmit"><br> <label>户籍所在地</label><input
				type="text" name="temp.hjszd" class="adresssubmit">? <label>联系地址</label><input
				type="text" name="temp.lxdz" value="" class="adresssubmit">
		...
		<div id="yg_fr" class="comeare" style="display: none">
			...
			<input name="temp.ssdw" value="0" type="hidden"> <input
				...
				type="text" name="temp.name" value="" class="inputsubmit">
			<label>单位负责人或法定代表人名称</label><input class="inputsubmit" type="text"
				name="temp.fr" value=""><br /> <label>邮政编码</label><input
				type="text" name="temp.yzbm" class="inputsubmit"> <label>手机号码</label><input
				type="text" name="temp.sjhm" value="" onblur="checkMobile(this);"
				class="inputsubmit"><br /> <label>联系电话</label><input
				type="text" name="temp.lxdh" class="inputsubmit"> <label>联系地址</label><input
		...
		<div id="yg_ffr" class="comeare" style="display: none">
			...
			<br /> <label>联系电话</label><input type="text" name="temp.lxdh"
				class="inputsubmit"><br /> <label>联系地址</label><input
				class="adresssubmit" type="text" name="temp.lxdz" value="">
			<%-- <div class="savesubmit"> <img src="${ctx}/js_css_image/images/savesubmit.jpg" /><img src="${ctx}/js_css_image/images/canclemit.jpg" /></div> --%>
		</div>
		...
		<div id="bg_zrr" class="comeare" style="display: none;">
			...
			<h2>
				<span><img src="${ctx}/js_css_image/images/editicon.jpg" /><img
					...
					onclick="deleteDiv(this);" tag="bg" />
				</span>被告自然人
			</h2>

			<input name="temp.ssdw" value="1" type="hidden"> <input
				name="temp.type" value="0" type="hidden"> <label>姓名</label><input
				name="temp.name" class="inputsubmit" type="text" value="">
			<label>身份证</label><input type="text" onblur="checkIdcard(this);"
				name="temp.sfz" value="" class="inputsubmit"><br /> <label>出生日期</label><input
				name="temp.csrq" size="11" type="text" class="inputsubmit">?<label>性别</label>
			<input name="temp.sex" type="checkbox" value="boy">男 <input
				type="checkbox" name="temp.sex" value="girl">女 <br>
			<label>民族</label><input name="temp.mz" class="inputsubmit"
				type="text"> <label>手机号码</label><input type="text"
				name="temp.sjhm" value="" onblur="checkMobile(this);"
				class="inputsubmit"> ?<br />
			<label>联系电话</label><input type="text" name="temp.lxdh"
				class="inputsubmit"> <label>国籍</label><input name="temp.gj"
				type="text" class="inputsubmit"><br /> <label>文化程度</label><input
				type="text" name="temp.whcd" class="inputsubmit">? <label>邮政编码</label><input
		...
		<div id="bg_fr" class="comeare" style="display: none;">
			...
			<label>联系电话</label><input type="text" name="temp.lxdh"
				class="inputsubmit"> <br />
			<label>联系地址</label><input class="adresssubmit" type="text"
				name="temp.lxdz" value="">
			<%-- <div class="savesubmit"> <img src="${ctx}/js_css_image/images/savesubmit.jpg" /><img src="${ctx}/js_css_image/images/canclemit.jpg" /></div> --%>
		</div>
		...
		<form id="dataUpload" name="dataUpload"
			action="${ctx4ej }/lawsuit/laxx_saveSSQQ.do?coid=${coid}" method="post"
			...
			<br> <img src="${ctx}/js_css_image/images/step03.jpg" /> <br />
			<br /> <br> 案件类型 <select name="lsLaxx.ajlx"
				class="selectsubmit">
				<option value="">请选择案件类型</option>
				<option value="1"
					<c:if test="${lsLaxx.ajlx=='1' }">selected="selected"</c:if>>民事案件</option>
				<option value="0"
					<c:if test="${lsLaxx.ajlx=='0' }">selected="selected"</c:if>>刑事案件</option>
				<option value="2"
					<c:if test="${lsLaxx.ajlx=='2' }">selected="selected"</c:if>>行政案件</option>
			</select> <br>诉的种类 <select name="lsLaxx.sdzl" onchange="change(this);"
				class="selectsubmit">
				<option value="">请选择诉的种类</option>
				<option value="0"
					<c:if test="${lsLaxx.sdzl=='0' }">selected="selected"</c:if>>变更之诉</option>
				<option value="1"
					<c:if test="${lsLaxx.sdzl=='1' }">selected="selected"</c:if>>确认之诉</option>
				<option value="2"
					<c:if test="${lsLaxx.sdzl=='2' }">selected="selected"</c:if>>给付之诉</option>
			</select> <br /> <span
				style="vertical-align:top; margin-top:6px; display:inline-block">填写诉讼请求：</span>
			<textarea name="ssqq" class="texteare">${lsLaxx.ssqq}</textarea>
			<input name="dqjd" type="hidden" value="${lsLaxx.dqjd }"> <br>

			<input type="hidden" name="modiflsah" value="">
			<div class="lead_btn" style="margin-top: 20px; margin-left:200px;">
				<a class="btn1 btn_reset"
					href="${ctx4ej }/lawsuit/laxx_goBack.do?goTo=2&coid=${coid}">上一步</a>&nbsp;&nbsp;&nbsp;&nbsp;
