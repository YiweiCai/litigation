...
<form method="post" action="${ctx }/lawsuit/xf_update.do" id="articleForm" enctype="multipart/form-data">
     ...
     <table width="100%" class="ftable">
		...
		<tr>
		   <th width="10%" >回复方式：</th>
		  <td colspan="3">
		    	<my:select pvalue="replyWay" rules="[{notNull:true, message:'请选择回复方式'}]" name="lsXf.replyWay" id="replyWay" firstoption="--"/>
		  </td>
		</tr>
		<tr>
		   <th width="10%" >回复内容：</th>
		  <td colspan="3">
		  	  <textarea rows="3" cols="50" id="replyContent" name="lsXf.replyContent" disabled="disabled" maxlength="255" rules="[{notNull:true, message:'请输入回复内容'}]"></textarea>
		  </td>
		</tr>
		<tr>
		   <th width="10%" >备注：</th>
		  <td colspan="3">
		  	  <textarea rows="3" cols="50" name="lsXf.bz" maxlength="255" ></textarea>
		  </td>
		</tr>
	  <tr>
