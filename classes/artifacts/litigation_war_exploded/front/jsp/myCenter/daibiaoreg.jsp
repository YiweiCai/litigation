...
<div class="bannerbg">
  <div class="layout">
    ...
    <div class="nav">
    <a href="${ctx }/${requestNameSpace}/index.htm">网站首页</a>
    <a href="${ctx }/${requestNameSpace}/cms/article_detail.do?articleId=118&channelId=4028e30a4d5a9ef3014d5ab165b00000">法院简介</a>
    <a href="${ctx }/${requestNameSpace}/cms/article_flist.htm?channelId=402881fb5093521c0150936401890007">法官专栏</a>
    <a href="${ctx }/${requestNameSpace}/myCenter/readAgreement.htm">诉讼服务</a>
    ...
    <a href="${ctx }/${requestNameSpace}/cms/article_flist.htm?channelId=402881fb50ae10770150ae1f23ee0008">庭审直播</a>
    <a href="${ctx }/${requestNameSpace}/cms/article_flist.htm?channelId=402881f7508813af0150887c99020002">精选案例</a></div>
  </div></div>
</div>
<div class="layregbg">
...
<input type="hidden" name="deptId" value="${deptId }" />
  ...
  <div class="layregname">代表委员注册</div> 
   ...
   <ul>
      ...
      <li>
        <label class="length">代表委员编号：</label>
        <input type="text" name="loginName" id="loginName" class="inputstyle" placeholder="请输入代表委员编号"  maxlength="16"
		                    		title="请输入6-16位的用户名" rules="[{notNull:true, message:'请输入代表委员编号'},{minLength:6, message:'代表委员编号至少为6位'},{fn:checkLoginName,message:'该律师证号已存在'}]" />
      ...
      <li>
        ...
        <input  class="layregnextbut" id="submitBtn"/>
                            已有账号？<a href="${ctx }/myCenter/daibiaologin.htm">请登录</a>
      </li>
    </ul>
    </form>
 </div>
