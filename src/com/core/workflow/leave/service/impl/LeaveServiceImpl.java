package com.core.workflow.leave.service.impl;
...
import com.core.base.dao.dbutils.BaseDbutilsDao;
...
import com.core.workflow.common.service.JbpmService;
import com.core.workflow.common.service.WorkFlowSettingService;
import com.core.workflow.leave.entity.LeaveWorkFlow;
import com.core.workflow.leave.entity.WfLeave;
import com.core.workflow.leave.entity.WfLeaveAudit;
import com.core.workflow.leave.service.LeaveService;
...
public class LeaveServiceImpl extends BaseServiceImpl<WfLeave> implements LeaveService {
	...
	public Page findPageHistoryTasks(Page page) throws Exception{
		 String userId = Sessions.getSysUser().getId();
		 Map<String,String> paramMap = new FastMap().newHashMap().set("userId1", userId).set("userId2", userId);
