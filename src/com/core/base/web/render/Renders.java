package com.core.base.web.render;
...
import com.core.base.utils.bean.Objects;
...
public class Renders {
	...
	//保存成功后，返回的json提示信息
	public static final JsonResult SAVE_SUCCESS = new EasyUiResult(LocaleUtils.getLocaleText("保存成功", "Save Success"));
	//修改成功后，返回的json提示信息
	public static final JsonResult UPDATE_SUCCESS = new EasyUiResult(LocaleUtils.getLocaleText("修改成功", "Update Success"));
	//删除成功后，返回的json提示信息
	public static final JsonResult DELETE_SUCCESS = new JsonResult(LocaleUtils.getLocaleText("删除成功", "Delete Success"));
