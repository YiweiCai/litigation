	...
	public String processResult() {
        ...
        if(StringUtils.isNotBlank(curorderattr) && curorderattr.equals(orderattr)){
        	if("desc".equals(curordertype)){
    			sb.append("&nbsp;<img src=\"").append(contextPath).append("/js_css_image/images/arrow_down.png\"/>");
    		}else if("asc".equals(curordertype)){
    			sb.append("&nbsp;<img src=\"").append(contextPath).append("/js_css_image/images/arrow_up.png\"/>");
    		}
        }else{
        	sb.append("<img src=\"").append(contextPath).append("/js_css_image/images/asc_desc.gif\"/>");
        }
		sb.append("</a>");
		return sb.toString();
	}
