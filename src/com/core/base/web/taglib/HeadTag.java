package com.core.base.web.taglib;
...
public class HeadTag extends BodyTagSupport{
	...
	public int doStartTag() throws JspException{
		...
		//String projectName = PropertiesUtil.getPropertyValue("messages_"+locale+".properties", "global.project.name");
		...
		result.append("<link type=\"text/css\" rel=\"stylesheet\" href=\""+ctx+"/js_css_image/css/main.css\"/>\n");
		...
		if(tree3){
			result.append("<link rel=\"StyleSheet\" type=\"text/css\" href=\""+ctx+"/js_css_image/css/zTree/3.4/zTreeStyle.css\"/>\n");
		}
		
		result.append("<!--基础js-->\n");
		result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/jquery/jquery-1.8.0.min.js\"></script>\n");
		result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/jquery.core.utils-1.0.js\"></script>\n");
		result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/lang/"+locale.toString()+".js\"></script>\n");
		
		if(true/*crud*/){
			result.append("<!--crud 操作js，所有crud操作均采用ajax方式-->\n");
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/jquery.core.crud.init-1.0.js\"></script>\n");
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/jquery.core.crud-1.0.js\"></script>\n");
			//easyui form,server返回json时，contentType需为text/html或text/plain，否则将提示下载内容
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/jquery/jquery.easyui.form_1.3.1.js\"></script>\n");
			//result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/jquery/jquery.form.js\"></script>\n");
		}
		if(easyui){
			result.append("<!--布局 js-->\n");
		...
		if(lhgdialog){
			...
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/lhgdialog/lhgdialog/lhgdialog.min.js?skin=mac\"></script>\n");
		}
		if(datePicker){
			result.append("<!--date、time js-->\n");
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/My97DatePicker/WdatePicker.js\" defer=\"defer\"></script>\n");
		}
		if(multiFile){
		...
		if(tree2){
			...
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/zTree/2.0/jquery.ztree-2.6.min.js\"></script>\n");
		}
		if(tree3){
			...
			result.append("<script type=\"text/javascript\" src=\""+ctx+"/js_css_image/js/base/zTreeExt.js\"></script>\n");
		}
