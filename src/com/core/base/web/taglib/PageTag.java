	...
	public String processResult() {
		...
		if("new page style".equals(style)){
			...
			if(LocaleUtils.EN_US.equals(LocaleUtils.getLocale())){
				...
				String pageSize_10="",pageSize_20="",pageSize_50="",pageSize_100=""/*,pageSize_500="",pageSize_1000=""*/;
				...
				else if(pageSize==100){pageSize_100="selected=\"selected\"";}
				else{pageSize_10="selected=\"selected\"";}
				
				sb.append("Per<select name=\""+varName+".pageSize\" id=\"page_pageSize\" onchange=\"toPage($('#totalPage')[0].form,'1');\">\n");
				sb.append("<option value=\"10\" "+pageSize_10+">10</option>" +
						...
						"<option value=\"100\" "+pageSize_100+">100</option>\n");
				...
				sb.append("每页<select name=\""+varName+".pageSize\" id=\"page_pageSize\" onchange=\"toPage($('#totalPage')[0].form,'1');\">\n");
				sb.append("<option value=\"10\" "+pageSize_10+">10</option>" +
						"<option value=\"20\" "+pageSize_20+">20</option>" +
						"<option value=\"50\" "+pageSize_50+">50</option>" +
						"<option value=\"100\" "+pageSize_100+">100</option>\n");
